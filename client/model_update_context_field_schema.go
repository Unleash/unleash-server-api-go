...
type _UpdateContextFieldSchema UpdateContextFieldSchema
...
func (o *UpdateContextFieldSchema) UnmarshalJSON(data []byte) (err error) {
	varUpdateContextFieldSchema := _UpdateContextFieldSchema{}

	err = json.Unmarshal(data, &varUpdateContextFieldSchema)

	if err != nil {
		return err
	}

	*o = UpdateContextFieldSchema(varUpdateContextFieldSchema)
