...
type _GetProjects403Response GetProjects403Response
...
func (o *GetProjects403Response) UnmarshalJSON(data []byte) (err error) {
	varGetProjects403Response := _GetProjects403Response{}

	err = json.Unmarshal(data, &varGetProjects403Response)

	if err != nil {
		return err
	}

	*o = GetProjects403Response(varGetProjects403Response)
