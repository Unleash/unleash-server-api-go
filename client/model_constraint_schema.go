...
// ConstraintSchema A strategy constraint. For more information, refer to [the strategy constraint reference documentation](https://docs.getunleash.io/reference/activation-strategies#constraints)
...
func (o *ConstraintSchema) UnmarshalJSON(data []byte) (err error) {
	...
	varConstraintSchema := _ConstraintSchema{}

	err = json.Unmarshal(data, &varConstraintSchema)

	if err != nil {
		return err
	}

	*o = ConstraintSchema(varConstraintSchema)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "contextName")
		delete(additionalProperties, "operator")
		delete(additionalProperties, "caseInsensitive")
