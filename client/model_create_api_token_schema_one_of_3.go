...
type _CreateApiTokenSchemaOneOf3 CreateApiTokenSchemaOneOf3
...
func (o *CreateApiTokenSchemaOneOf3) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateApiTokenSchemaOneOf3 := _CreateApiTokenSchemaOneOf3{}

	err = json.Unmarshal(data, &varCreateApiTokenSchemaOneOf3)

	if err != nil {
		return err
	}

	*o = CreateApiTokenSchemaOneOf3(varCreateApiTokenSchemaOneOf3)
