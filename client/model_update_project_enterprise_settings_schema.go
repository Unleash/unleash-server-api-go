...
func (o *UpdateProjectEnterpriseSettingsSchema) GetLinkTemplates() []ProjectLinkTemplateSchema {
	if o == nil || IsNil(o.LinkTemplates) {
		var ret []ProjectLinkTemplateSchema
		return ret
	}
	return o.LinkTemplates
}

// GetLinkTemplatesOk returns a tuple with the LinkTemplates field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateProjectEnterpriseSettingsSchema) GetLinkTemplatesOk() ([]ProjectLinkTemplateSchema, bool) {
	if o == nil || IsNil(o.LinkTemplates) {
		return nil, false
	}
	return o.LinkTemplates, true
}
...
func (o UpdateProjectEnterpriseSettingsSchema) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LinkTemplates) {
		toSerialize["linkTemplates"] = o.LinkTemplates
	}
...
func (o *UpdateProjectEnterpriseSettingsSchema) UnmarshalJSON(data []byte) (err error) {
	...
	*o = UpdateProjectEnterpriseSettingsSchema(varUpdateProjectEnterpriseSettingsSchema)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "linkTemplates")
