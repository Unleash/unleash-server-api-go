...
// checks if the ProjectSchemaOwnersInnerOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectSchemaOwnersInnerOneOf{}

// ProjectSchemaOwnersInnerOneOf struct for ProjectSchemaOwnersInnerOneOf
type ProjectSchemaOwnersInnerOneOf struct {
...
type _ProjectSchemaOwnersInnerOneOf ProjectSchemaOwnersInnerOneOf
...
func NewProjectSchemaOwnersInnerOneOf(ownerType string, name string) *ProjectSchemaOwnersInnerOneOf {
	this := ProjectSchemaOwnersInnerOneOf{}
...
func (o *ProjectSchemaOwnersInnerOneOf) SetImageUrlNil() {
	o.ImageUrl.Set(nil)
}
...
func (o *ProjectSchemaOwnersInnerOneOf) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o ProjectSchemaOwnersInnerOneOf) MarshalJSON() ([]byte, error) {
...
func (o ProjectSchemaOwnersInnerOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectSchemaOwnersInnerOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectSchemaOwnersInnerOneOf := _ProjectSchemaOwnersInnerOneOf{}

	err = json.Unmarshal(data, &varProjectSchemaOwnersInnerOneOf)

	if err != nil {
		return err
	}

	*o = ProjectSchemaOwnersInnerOneOf(varProjectSchemaOwnersInnerOneOf)
...
type NullableProjectSchemaOwnersInnerOneOf struct {
	value *ProjectSchemaOwnersInnerOneOf
	isSet bool
}

func (v NullableProjectSchemaOwnersInnerOneOf) Get() *ProjectSchemaOwnersInnerOneOf {
	return v.value
}

func (v *NullableProjectSchemaOwnersInnerOneOf) Set(val *ProjectSchemaOwnersInnerOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectSchemaOwnersInnerOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectSchemaOwnersInnerOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectSchemaOwnersInnerOneOf(val *ProjectSchemaOwnersInnerOneOf) *NullableProjectSchemaOwnersInnerOneOf {
	return &NullableProjectSchemaOwnersInnerOneOf{value: val, isSet: true}
}

func (v NullableProjectSchemaOwnersInnerOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectSchemaOwnersInnerOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
