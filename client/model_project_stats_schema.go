...
func (o *ProjectStatsSchema) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectStatsSchema := _ProjectStatsSchema{}

	err = json.Unmarshal(data, &varProjectStatsSchema)

	if err != nil {
		return err
	}

	*o = ProjectStatsSchema(varProjectStatsSchema)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "avgTimeToProdCurrentWindow")
		delete(additionalProperties, "createdCurrentWindow")
		delete(additionalProperties, "createdPastWindow")
		delete(additionalProperties, "archivedCurrentWindow")
		delete(additionalProperties, "archivedPastWindow")
		delete(additionalProperties, "projectActivityCurrentWindow")
		delete(additionalProperties, "projectActivityPastWindow")
		delete(additionalProperties, "projectMembersAddedCurrentWindow")
