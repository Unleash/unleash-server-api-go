...
func (o *EnvironmentProjectSchema) UnmarshalJSON(data []byte) (err error) {
	...
	varEnvironmentProjectSchema := _EnvironmentProjectSchema{}

	err = json.Unmarshal(data, &varEnvironmentProjectSchema)

	if err != nil {
		return err
	}

	*o = EnvironmentProjectSchema(varEnvironmentProjectSchema)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "projectApiTokenCount")
		delete(additionalProperties, "projectEnabledToggleCount")
