...
type _CreateContextFieldSchema CreateContextFieldSchema
...
func (o *CreateContextFieldSchema) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateContextFieldSchema := _CreateContextFieldSchema{}

	err = json.Unmarshal(data, &varCreateContextFieldSchema)

	if err != nil {
		return err
	}

	*o = CreateContextFieldSchema(varCreateContextFieldSchema)
