...
[**GetRawFeatureMetrics**](MetricsAPI.md#GetRawFeatureMetrics) | **Get** /api/admin/client-metrics/features/{name}/raw | Get feature metrics
...
> CreateApplication(ctx, appName).CreateApplicationSchema(createApplicationSchema).Execute()
...
func main() {
    ...
    createApplicationSchema := *openapiclient.NewCreateApplicationSchema() // CreateApplicationSchema | createApplicationSchema

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.MetricsAPI.CreateApplication(context.Background(), appName).CreateApplicationSchema(createApplicationSchema).Execute()
    if err != nil {
 ...
 **createApplicationSchema** | [**CreateApplicationSchema**](CreateApplicationSchema.md) | createApplicationSchema | 
