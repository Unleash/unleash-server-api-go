...
**Id** | Pointer to **int32** | The group&#39;s ID in the Unleash system | [optional] 
...
`func NewGroupWithProjectRoleSchema() *GroupWithProjectRoleSchema`
...
`func (o *GroupWithProjectRoleSchema) HasId() bool`
