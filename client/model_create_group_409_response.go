...
type _CreateGroup409Response CreateGroup409Response
...
func (o *CreateGroup409Response) UnmarshalJSON(data []byte) (err error) {
	varCreateGroup409Response := _CreateGroup409Response{}

	err = json.Unmarshal(data, &varCreateGroup409Response)

	if err != nil {
		return err
	}

	*o = CreateGroup409Response(varCreateGroup409Response)
