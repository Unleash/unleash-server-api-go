...
type ApiSetProjectAccessRequest struct {
	...
	ApiService                       *ProjectsAPIService
	projectId                        string
	projectAccessConfigurationSchema *ProjectAccessConfigurationSchema
}
...
func (r ApiSetProjectAccessRequest) ProjectAccessConfigurationSchema(projectAccessConfigurationSchema ProjectAccessConfigurationSchema) ApiSetProjectAccessRequest {
	r.projectAccessConfigurationSchema = &projectAccessConfigurationSchema
	return r
}

func (r ApiSetProjectAccessRequest) Execute() (*http.Response, error) {
	return r.ApiService.SetProjectAccessExecute(r)
}
...
func (a *ProjectsAPIService) SetProjectAccessExecute(r ApiSetProjectAccessRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectsAPIService.SetProjectAccess")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.projectAccessConfigurationSchema == nil {
		return nil, reportError("projectAccessConfigurationSchema is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.projectAccessConfigurationSchema
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
func (r ApiUpdateProjectEnterpriseSettingsRequest) UpdateProjectEnterpriseSettingsSchema(updateProjectEnterpriseSettingsSchema UpdateProjectEnterpriseSettingsSchema) ApiUpdateProjectEnterpriseSettingsRequest {
	r.updateProjectEnterpriseSettingsSchema = &updateProjectEnterpriseSettingsSchema
	return r
}

func (r ApiUpdateProjectEnterpriseSettingsRequest) Execute() (*http.Response, error) {
	return r.ApiService.UpdateProjectEnterpriseSettingsExecute(r)
}
...
func (a *ProjectsAPIService) UpdateProjectEnterpriseSettingsExecute(r ApiUpdateProjectEnterpriseSettingsRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectsAPIService.UpdateProjectEnterpriseSettings")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateProjectEnterpriseSettingsSchema == nil {
		return nil, reportError("updateProjectEnterpriseSettingsSchema is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateProjectEnterpriseSettingsSchema
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
