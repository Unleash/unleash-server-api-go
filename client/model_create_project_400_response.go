...
type _CreateProject400Response CreateProject400Response
...
func (o *CreateProject400Response) UnmarshalJSON(data []byte) (err error) {
	varCreateProject400Response := _CreateProject400Response{}

	err = json.Unmarshal(data, &varCreateProject400Response)

	if err != nil {
		return err
	}

	*o = CreateProject400Response(varCreateProject400Response)
