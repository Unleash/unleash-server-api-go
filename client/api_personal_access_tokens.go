...
*/
func (a *PersonalAccessTokensApiService) CreatePat(ctx context.Context) ApiCreatePatRequest {
	return ApiCreatePatRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//  @return PatSchema
func (a *PersonalAccessTokensApiService) CreatePatExecute(r ApiCreatePatRequest) (*PatSchema, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonalAccessTokensApiService.CreatePat")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/admin/user/tokens"
...
*/
func (a *PersonalAccessTokensApiService) DeletePat(ctx context.Context, id string) ApiDeletePatRequest {
	return ApiDeletePatRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *PersonalAccessTokensApiService) DeletePatExecute(r ApiDeletePatRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonalAccessTokensApiService.DeletePat")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/admin/user/tokens/{id}"
...
func (r ApiGetPatsRequest) Execute() (*PatsSchema, *http.Response, error) {
	return r.ApiService.GetPatsExecute(r)
}
...
*/
func (a *PersonalAccessTokensApiService) GetPats(ctx context.Context) ApiGetPatsRequest {
	return ApiGetPatsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//  @return PatsSchema
func (a *PersonalAccessTokensApiService) GetPatsExecute(r ApiGetPatsRequest) (*PatsSchema, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonalAccessTokensApiService.GetPats")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
