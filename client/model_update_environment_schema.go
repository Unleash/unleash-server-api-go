...
// UpdateEnvironmentSchema Data used to update an [environment](https://docs.getunleash.io/reference/environments).
...
type _UpdateEnvironmentSchema UpdateEnvironmentSchema
...
func (o *UpdateEnvironmentSchema) GetRequiredApprovals() int32 {
	if o == nil || IsNil(o.RequiredApprovals.Get()) {
		var ret int32
		return ret
	}
...
func (o *UpdateEnvironmentSchema) HasRequiredApprovals() bool {
	if o != nil && o.RequiredApprovals.IsSet() {
		return true
	}
...
func (o *UpdateEnvironmentSchema) UnmarshalJSON(data []byte) (err error) {
	varUpdateEnvironmentSchema := _UpdateEnvironmentSchema{}

	err = json.Unmarshal(data, &varUpdateEnvironmentSchema)

	if err != nil {
		return err
	}

	*o = UpdateEnvironmentSchema(varUpdateEnvironmentSchema)
