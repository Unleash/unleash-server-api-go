...
type ProjectSchema struct {
	...
	Owners              *ProjectSchemaOwners `json:"owners,omitempty"`
}
...
// SetOwners gets a reference to the given ProjectSchemaOwners and assigns it to the Owners field.
