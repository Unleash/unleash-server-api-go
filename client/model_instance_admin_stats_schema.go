...
type InstanceAdminStatsSchema struct {
	...
	ActiveUsers *InstanceAdminStatsSchemaActiveUsers `json:"activeUsers,omitempty"`
...
func (o *InstanceAdminStatsSchema) GetActiveUsers() InstanceAdminStatsSchemaActiveUsers {
	if o == nil || IsNil(o.ActiveUsers) {
		var ret InstanceAdminStatsSchemaActiveUsers
		return ret
	}
...
// SetActiveUsers gets a reference to the given InstanceAdminStatsSchemaActiveUsers and assigns it to the ActiveUsers field.
...
// GetFeatureExports returns the FeatureExports field value if set, zero value otherwise.
func (o *InstanceAdminStatsSchema) GetFeatureExports() float32 {
	if o == nil || IsNil(o.FeatureExports) {
		var ret float32
		return ret
	}
	return *o.FeatureExports
}

// GetFeatureExportsOk returns a tuple with the FeatureExports field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InstanceAdminStatsSchema) GetFeatureExportsOk() (*float32, bool) {
	if o == nil || IsNil(o.FeatureExports) {
		return nil, false
	}
	return o.FeatureExports, true
}
...
// SetFeatureExports gets a reference to the given float32 and assigns it to the FeatureExports field.
...
func (o *InstanceAdminStatsSchema) GetFeatureImports() float32 {
	if o == nil || IsNil(o.FeatureImports) {
		var ret float32
		return ret
	}
...
// SetFeatureImports gets a reference to the given float32 and assigns it to the FeatureImports field.
...
func (o InstanceAdminStatsSchema) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FeatureExports) {
		toSerialize["featureExports"] = o.FeatureExports
	}
	if !IsNil(o.FeatureImports) {
