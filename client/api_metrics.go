...
func (r ApiCreateApplicationRequest) CreateApplicationSchema(createApplicationSchema CreateApplicationSchema) ApiCreateApplicationRequest {
	r.createApplicationSchema = &createApplicationSchema
	return r
}
...
func (a *MetricsAPIService) CreateApplicationExecute(r ApiCreateApplicationRequest) (*http.Response, error) {
	...
	if r.createApplicationSchema == nil {
		return nil, reportError("createApplicationSchema is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createApplicationSchema
	if r.ctx != nil {
